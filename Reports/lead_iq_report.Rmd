...
```{bash}
git add Reports/lead_iq_report.Rmd Reports/lead_iq_report.html Reports/lead_iq_report.pdf Reports/lead_iq_report.docx

git commit -m "HW 02 report - update to remove 999 outlier"
git push
